...
<head>
    ...
    <title>Add Boarding House - BoardingPH</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-header">
            ...
            <p>Fill in the details below to list a new boarding house.</p>
        </div>
        ...
        <form action="{{ route('boarding-houses.store') }}" method="POST">
            @csrf
            ...
            <div class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Sunrise Boarding House" required>
                        @error('name')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="e.g. 123 Rizal St, Brgy. San Antonio" required>
                        @error('location')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <input type="radio" name="room_type" id="room_single" value="single" {{ old('room_type', 'single') === 'single' ? 'checked' : '' }}>
                            ...
                            <div class="radio-option">
                                <input type="radio" name="room_type" id="room_shared" value="shared" {{ old('room_type') === 'shared' ? 'checked' : '' }}>
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="total_beds" id="total_beds" value="{{ old('total_beds') }}" min="1" placeholder="e.g. 4" required>
                            @error('total_beds')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" name="available_beds" id="available_beds" value="{{ old('available_beds') }}" min="0" placeholder="e.g. 2" required>
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="size_sqm" id="size_sqm" value="{{ old('size_sqm') }}" placeholder="e.g. 18">
                            @error('size_sqm')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="price_per_month" id="price_per_month" value="{{ old('price_per_month') }}" placeholder="e.g. 5000" required>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" placeholder="Describe the boarding house, amenities, rules, nearby landmarks…">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                    </div>
